#ifndef MATHLIB_COMMON_IMPL_STRONG_TYPES_OPERATORS_HPP
#define MATHLIB_COMMON_IMPL_STRONG_TYPES_OPERATORS_HPP
...
#endif //MATHLIB_COMMON_IMPL_STRONG_TYPES_OPERATORS_HPP
