...
TEST_CASE("TypePack creation and basic utilities", "[Math][Common]")
{
    ...
    {
        STATIC_REQUIRE(Math::Concept::IsSame<Pack::At<0>, i32>);
        STATIC_REQUIRE(Math::Concept::IsSame<Pack::At<1>, i64>);
        STATIC_REQUIRE(Math::Concept::IsSame<Pack::At<2>, f32>);
        STATIC_REQUIRE(Math::Concept::IsSame<Pack::At<3>, f64>);
    }
    ...
    SECTION("Test Pack::Append")
    {
        ...
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<0>, i32>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<1>, i64>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<2>, f32>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<3>, f64>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<4>, SizeType>);
    }
    ...
    SECTION("Test Pack::Prepend")
    {
        ...
        STATIC_REQUIRE(ResultPack::Size == 5);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<0>, SizeType>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<1>, i32>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<2>, i64>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<3>, f32>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<4>, f64>);
    }
    ...
    SECTION("Test RemoveAt")
    {
        ...
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<0>, i32>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<1>, i64>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<2>, f64>);
    }
    ...
    SECTION("Test RemoveFirst")
    {
        ...
        STATIC_REQUIRE(ResultPack::Size == 3);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<0>, i64>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<1>, f32>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<2>, f64>);
    }
    ...
    SECTION("Test Reverse")
    {
        ...
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<0>, f64>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<1>, f32>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<2>, i64>);
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<3>, i32>);
    }
    ...
    SECTION("Test Zip")
    {
        ...
        STATIC_REQUIRE(Math::Concept::IsSame<ResultPack::At<0>, Math::TypePack<i32, SizeType>>);
    }
