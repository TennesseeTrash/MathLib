...
TEST_CASE("Point2f-Vector2f operators", "[Point][Math]")
{
    ...
    SECTION("Point2f / Vector2f")
    {
        ...
        Math::Vector2f v(3.0f, 4.0f);
        Math::Point2f p2 = p / v;
        REQUIRE(Math::Equal(p2.x, 1.0f / 3.0f));
        REQUIRE(Math::Equal(p2.y, 2.0f / 4.0f));
    }
    ...
    SECTION("Point2f /= Vector2f")
    {
        ...
        Math::Vector2f v(3.0f, 4.0f);
        p /= v;
        REQUIRE(Math::Equal(p.x, 1.0f / 3.0f));
        REQUIRE(Math::Equal(p.y, 2.0f / 4.0f));
    }
}
...
TEST_CASE("Point3f-Vector3f operators")
{
    ...
    SECTION("Point3f / Vector3f")
    {
        ...
        Math::Vector3f v(4.0f, 5.0f, 6.0f);
        Math::Point3f p2 = p / v;
        REQUIRE(Math::Equal(p2.x, 1.0f / 4.0f));
        REQUIRE(Math::Equal(p2.y, 2.0f / 5.0f));
        REQUIRE(Math::Equal(p2.z, 3.0f / 6.0f));
    }
    ...
    SECTION("Point3f *= Vector3f")
    {
        ...
        p *= v;
        REQUIRE(Math::Equal(p.x, 4.0f));
        REQUIRE(Math::Equal(p.y, 10.0f));
        REQUIRE(Math::Equal(p.z, 18.0f));
    }
    ...
    SECTION("Point3f /= Vector3f")
    {
        ...
        Math::Vector3f v(4.0f, 5.0f, 6.0f);
        p /= v;
        REQUIRE(Math::Equal(p.x, 1.0f / 4.0f));
        REQUIRE(Math::Equal(p.y, 2.0f / 5.0f));
        REQUIRE(Math::Equal(p.z, 3.0f / 6.0f));
    }
}
